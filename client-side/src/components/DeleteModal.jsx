    ...
    <div  className="m-auto p-4 w-full max-w-md h-full ">
        <div className="relative p-4 text-center bg-white rounded-lg shadow ">
            ...
            <div className="flex justify-center items-center space-x-4">
                <button onClick={() => {setIsDeleteModalOpen(false)}} data-modal-toggle="deleteModal" type="button" className="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 ">
                    No, cancel
                </button>
                <button onClick={() => {deleteNote(noteId);setIsDeleteModalOpen(false)}} type="submit" className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 ">
                    Yes, I'm sure
                </button>
            </div>
        </div>
